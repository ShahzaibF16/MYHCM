            ...
            <div className='col-lg-8'>
              <div className='blog-details-page-content'>
                <div className='single-blog-inner mb-0'>
                  <div className='thumb'>
                    <img src='assets/img/modules/18.jpeg' alt='img' />
                  </div>
                  <div className='details'>
                    <h4>
                    ...
                    <p>
                      Transform HR tasks with voice commands. Our software employs voice-over commands for efficient,
                      hands-free task completion. The mobile app features precise voice recognition, allowing HR
                      professionals to multitask and respond to urgent matters effortlessly. Integration with voice
                      assistants like Cortana, Alexa, and Siri ensures a seamless and convenient HR management experience.
                      Elevate efficiency and comfort in achieving professional goals with MyHCM's advanced voice command features.
                    </p>
                  </div>
                </div>
              </div>
...
export default VoiceEnabledDetails;
